...
import HeaderRightButtonGroup from "./_components/RightButtonGroup";
...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 z-99999 w-full bg-white py-4! shadow-xs transition duration-100 dark:bg-black">
